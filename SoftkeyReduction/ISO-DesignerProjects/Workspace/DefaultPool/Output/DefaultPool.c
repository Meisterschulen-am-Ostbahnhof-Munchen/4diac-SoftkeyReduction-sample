...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(SoftKey_5005), TYPEID_SOFTKEY, COLOR(221), 1, 1, 0, 
		XYREF(OutputNumber_12005, 2, 2),
	...
	ID(SoftKey_5011), TYPEID_SOFTKEY, COLOR(221), 1, 1, 0, 
		XYREF(OutputNumber_12011, 2, 2),
	...
	ID(OutputNumber_12005), TYPEID_OUTNUM, WORD(68), WORD(68), COLOR_WHITE, ID(FontAttributes_23000), 0,
		ID(ID_NULL), LONG(5UL), LONG(0L), FLOAT_1, 0, 0, 5, 0,
	...
	ID(OutputNumber_12011), TYPEID_OUTNUM, WORD(68), WORD(68), COLOR_WHITE, ID(FontAttributes_23000), 0,
		ID(ID_NULL), LONG(11UL), LONG(0L), FLOAT_1, 0, 0, 5, 0,
